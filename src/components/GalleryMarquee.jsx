...
export default function GalleryMarquee() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center overflow-hidden bg-black relative">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 -mt-[28px] md:-mt-12 transform -rotate-3 scale-110 md:scale-105 w-full relative">
        {renderRow(row1, false, false)}

        {/* Chữ GRADUATE nằm giữa line 2 hàng ảnh */}
