...
export const HeartCollage = ({
    ...
    return (
        <div className="flex flex-col items-center justify-center py-2 sm:py-6 relative select-none w-full bg-[#fdfaf6] overflow-hidden">
            ...
            <div className="w-full max-w-[360px] sm:max-w-[420px] md:max-w-[550px] lg:max-w-[700px] xl:max-w-[850px] px-2 sm:px-4 py-2 sm:py-6 flex justify-center relative mx-auto z-10">
